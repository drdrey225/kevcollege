...
const DashSidebarSM = () => {
  return (
    <>
      <div className="border fixed h-[calc(100vh-0rem)]  max-w-lg p-4 ">
        <div className="flex flex-col gap-6">
          <Link
            to="/profile"
            className=" mx-10 my-6 h-24 w-24 border rounded-full overflow-hidden"
          >
            <img src={mypic} alt="me" className="" />
          </Link>
