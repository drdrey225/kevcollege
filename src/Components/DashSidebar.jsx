...
const DashSidebar = () => {
  let url = "http://localhost:3800/user/imageupload";
  ...
  return (
    <>
      <div className="border md:block hidden fixed h-[calc(100vh-0rem)]  max-w-lg p-4">
        <div className="flex flex-col gap-6">
          <div>
            {data.map(() => (
              <div className="border">
                ...
                className="cursor-pointer mx-10 my-6 h-24 w-24 border rounded-full overflow-hidden"
              />
              </div>
            ))} 
          </div>

          <div className="md:px-10 px-4 md:pr-24 pr-8  md:py-3 py-2 rounded hover:bg-slate-200 flex gap-2">
            <svg
          ...
          {/* <div className="md:px-10 px-4 md:pr-24 pr-8 md:py-3 py-2 md:block hidden rounded hover:bg-slate-200 md:flex gap-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
          ...
          <div className="md:px-10 px-4 md:pr-24 pr-8 md:py-3 py-2 rounded hover:bg-slate-200 mb-10 flex gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
